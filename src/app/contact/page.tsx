            ...
            <Card className="h-full">
              ...
              <CardContent className="space-y-4">
                ...
                <div className="flex items-center space-x-3">
                  ...
                  <a href="https://github.com/richardissailing" target="_blank" rel="noopener noreferrer" className="text-primary hover:underline">
                    github.com/richardissailing
                  </a>
                </div>
                <div className="flex items-center space-x-3">
                  <svg className="h-5 w-5" fill="currentColor" viewBox="0 0 24 24">
                  ...
                  <a href="https://www.linkedin.com/in/richard-kirkham88/" target="_blank" rel="noopener noreferrer" className="text-primary hover:underline">
                    linkedin.com/in/richard-kirkham88/
                  </a>
                </div>
              </CardContent>
            </Card>
